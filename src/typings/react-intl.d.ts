declare namespace ReactIntl {
    ...
    function injectIntl<P, T>(
        component: React.ComponentType<P & InjectedIntlProps<T>>,
        options?: InjectIntlConfig,
    ): React.ComponentClass<Pick<P, Exclude<keyof P, keyof InjectedIntlProps<T>>>> & {
        WrappedComponent: React.ComponentType<P & InjectedIntlProps<T>>
    }

    function addLocaleData<T>(data: Locale<T>[] | Locale<T>): void

    type Messages<T, Names extends keyof any = string> = { [key in Names]: FormattedMessage.MessageDescriptor<T> }

    function defineMessages<Names extends keyof unknown>(messages: Messages<Names>): Messages<Names>

    interface IntlConfig {
        locale: React.Requireable<unknown>
        formats: React.Requireable<unknown>
        messages: React.Requireable<unknown>
        defaultLocale: React.Requireable<unknown>
        defaultFormats: React.Requireable<unknown>
        onError: React.Requireable<unknown>
    }

    interface IntlFormat {
        formatDate: React.Requireable<unknown>
        formatTime: React.Requireable<unknown>
        formatRelative: React.Requireable<unknown>
        formatNumber: React.Requireable<unknown>
        formatPlural: React.Requireable<unknown>
        formatMessage: React.Requireable<unknown>
        formatHTMLMessage: React.Requireable<unknown>
    }

    interface IntlShape extends IntlConfig, IntlFormat, React.Requireable<unknown> {
        now: React.Requireable<unknown>
    }

    const intlShape: IntlShape

    interface InjectedIntl<T> {
        ...
        formatRelative(value: DateSource, options?: FormattedRelative.PropsBase & { now?: unknown }): string
        ...
        formatMessage(
            messageDescriptor: FormattedMessage.MessageDescriptor<T>,
    ...
    namespace FormattedMessage {
        ...
        interface Props<T> extends MessageDescriptor<T> {
            values?: { [key: string]: MessageValue | JSX.Element }
            tagName?: React.ReactType
            children?: (...formattedMessage: Array<string | JSX.Element>) => React.ReactNode
        }
    }
    class FormattedMessage<T> extends React.Component<FormattedMessage.Props<T>> {}

    class FormattedHTMLMessage<T> extends React.Component<FormattedMessage.Props<T>> {}
...
declare module "react-intl/locale-data/af" {
    const data: ReactIntl.LocaleData<unknown>
    export = data
}
